...
### MineContext(Chinese): Create with Context, Clarity from Chaos
...
> This repository is a personal fork of MineContext with localized UI (Simplified Chinese) and custom tweaks.

[中文](README_zh.md) / English

<a href="https://bytedance.larkoffice.com/wiki/Hn6ewRnAwiSro7kkH6Sc1DMFnng">Community Best Practice</a> · <a href="https://github.com/Deng-Alan/MineContext/issues">Report Issues</a> · <a href="https://bytedance.larkoffice.com/share/base/form/shrcnPAjJtlufuhBZGegll41NOh">Feedback</a>
...
<a href="https://github.com/Deng-Alan/MineContext/releases">🖥️ Download for Mac</a> · <a href="https://github.com/Deng-Alan/MineContext/releases">💻 Download for Windows</a>
...
Click [Github Latest Release](https://github.com/Deng-Alan/MineContext/releases) to Download
...
```bash
./build.bat   # Build backend (on Windows you can also run .\build.bat in PowerShell)
cd frontend
npm run build:win
# The installer (MineContext-<version>-setup.exe) will be generated in frontend/dist
```
...
- [GitHub Issues](https://github.com/Deng-Alan/MineContext/issues): Errors and issues encountered while using MineContext.
